...
if __name__ == "__main__":
    ...
    from qldb-orm.qldb import Query, Document
    ...
    #  element of the list will be an object of type `qldb-orm.qldb.Document`
    doc = Document(
        'test_table', id="7e1e93138bfd11ec8b4fb07d647734f0", stranded=True)
